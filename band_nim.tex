...
Each bar has a cross section of $7.2 \times 7.2\,\mathrm{cm}^{2}$ and are made of BC-408 scintillant. Three different long bars are used in the detector: 15 bars with a length of $164\,\mathrm{cm}$ (xx in Fig. \ref{fig:design}), 43 bars with a length of $202\,\mathrm{cm}$ (xx in Fig. \ref{fig:design}) and 58 short bars with a length of $51\,\mathrm{cm}$ (in Fig. \ref{fig:design}). The short bars are necessary for hole for the beam line and target installation. The total thickness is $36\,\mathrm{cm}$.
All bars are read-out on both sides by PMTs (100 Hamamatsu R7724 and 132 ET 9214) giving a total of 232 active channels
a veto layer is installed with 24 scintillators bars which are read-out only on one side by Thorne EMI 9954KB PMTs. The bars have a cross section of $2 \times 7.2\,\mathrm{cm}^{2}$. The bars in the veto layer have the same length as the bars of one layer of the active detector area. The veto layer is shown in Fig. \ref{fig:design}.
