...
Bench measurements have been cnoducted to select the reflective wrapping of the bars and the PMTs.
...
\begin{table}[t!]
	\caption{Bench test configurations. Resolution given $2$ \si{\mega\electronvolt} energy deposit in middle of bar. {\color{red}TO DO (Efrain): Update Sigma values}}
\centering
	\begin{tabular}{ m{5em}  m{4em}  m{3em}   m{3em} }
		\hline
			PMT & Reflector & Length (cm) & $\sigma$ (\si{\pico\second})\\
		\hline\hline
			R7724-10 & ESR &   200 & 150	\\
...
{\color{red}ADD Information about PMTs and voltage divider. Also add information about connection of PMTs with light guides to bars.}
\begin{table*}[tbh]
\caption{Properties of the PMTs used in BAND. }
\centering
\begin{tabular} { l  l  l l } \hline
 &  R7724 & 9214 & 9954KB \\ \hline\hline
...
{\color{red}Do we want to show a picture/drawing of lightguides? Or just mention them}
