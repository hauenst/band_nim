...
%Taking into account the results from cosmic ray and source
%measurement, we obtain a ADC to MeV conversion function
...
%\footnotemark \footnotetext{NOTE FOR
%  FIRST CIRCULAR: This plot will be updated with the results for layer
%  5 in the next days}
